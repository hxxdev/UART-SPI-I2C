...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {BTNC}];  # use BTNC as reset button.
set_property PACKAGE_PIN R16 [get_ports {BTND}];  # use BTND as user switch.
...
## ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {D_SW[0]}];  # "D_SW[0]"
set_property PACKAGE_PIN G22 [get_ports {D_SW[1]}];  # "D_SW[1]"
set_property PACKAGE_PIN H22 [get_ports {D_SW[2]}];  # "D_SW[2]"
set_property PACKAGE_PIN F21 [get_ports {D_SW[3]}];  # "D_SW[3]"
set_property PACKAGE_PIN H19 [get_ports {D_SW[4]}];  # "D_SW[4]"
set_property PACKAGE_PIN H18 [get_ports {D_SW[5]}];  # "D_SW[5]"
set_property PACKAGE_PIN H17 [get_ports {D_SW[6]}];  # "D_SW[6]"
set_property PACKAGE_PIN M15 [get_ports {D_SW[7]}];  # "D_SW[7]"
